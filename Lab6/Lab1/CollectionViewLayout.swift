...
class CollectionViewLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            let width = (item % 8 == 4 ? 3.0 : 1.0) * columnWidth
            ...
            let itemPoModolyu = item % 8
            column = (itemPoModolyu < 3) ? 0 : (item % 8 == 1 || itemPoModolyu == 2 ||  itemPoModolyu == 3 || itemPoModolyu == 4) ? 1 : (itemPoModolyu == 5 ) ? 2 : itemPoModolyu == 6 ? itemPoModolyu-3 : (itemPoModolyu-1)
        }
    }
